...
public class PlayerCountryData {
	@Test
	  @DataProvider(name="RcbTeam_Country")
	  public Iterator<Object> readRcbCountryData() throws FileNotFoundException {
		 	
		  JsonPath jsonPath= JsonPath.given(new FileReader(new File(TestUtilities.filePath)));
		  List<Object> lst= jsonPath.getList("player.country");	   	  
		  return lst.iterator();
